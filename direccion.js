export default class Direccion{
     ...
     */
    constructor(calle,numeroExterior,colonia,codigoPostal,ciudad,municipio,numeroInterior=''){
        this.calle = calle;
    ...
    getFormatoExtendido(){
        return `${this.calle} #${this.numeroExterior}, ${'#'+this.numeroInterior+','} Col. ${this.colonia},;
        Código Postal: ${this.codigoPostal}, ${this.ciudad}, ${this.municipio}`;
    }
}

/*
let art1 = new Direccion('Paseo de Azaleaz',246,'Jardines de Bugambilias',28978,'Colima','Villa de ALvarez');
console.log(art1.getFormatoCorto());
console.log(art1.getFormatoExtendido());
*/
